...
`s3_server_side_encryption` -  Encryption is **on** by default.  Set to false to turn off AWS' AES256 encryption.  Support for AWS KMS keys is not currently supported.
